...
class SelectPage(BasePage):
    ...
    def __init__(self,driver):
        ...
        self.input1_element=(By.XPATH,"//div[@id='withOptGroup']//input") #input elemente to click and type text
    ...
    def click_select_value_dropdown(self):
        ...
        BasePage.click_element(self, element = self.input1_element)
    ...
    def type_text_select_dropdown(self,text):
        ...
        BasePage.type_text(self, element = self.input1_element, text = text)
